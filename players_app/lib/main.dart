  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Center(
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center, // Correct capitalization
            children: <Widget>[
              Image.network(
                playerList[_counter],
                height: 300,
        ...
        floatingActionButton: FloatingActionButton( // Correct capitalization and placement
          onPressed: () {
          ...
          tooltip: 'Increment',
          child: const Icon(Icons.add), // Correct the Icon syntax
        ),
      ),
    );
  }
